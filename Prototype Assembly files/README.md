...
- 4mm plywood for lasercutting box
- 2 little hooks to attach elastic bands
- Wooden stick with 2.5cm diameter and 1cm diameter for handle
- Silicone stubes 
...
- Paint the outside box with water-repellent white paint and let dry
...
- Put the board with the microcontroller, the casing with the motor and the sensors into the box
- Attach the sensors to the right outer side of the box using glue at approx. 80% ROM
- Drill a hole on the left outer side of the box for the soap tube
- Drill a hole in the middle of the lid of the soap container
- Connect the tube on the one side to the pump system on top of the dispenser case
- Guide the tube on the other side through the whole in the box on the right outer side
- Guide the tube through the hole in the soap container lid until it reaches the bottom of the container 
...
- Glue the small rectangular top parts onto the inside walls to cover up the sensors
- Put in the inside bottom that covers up the soap dispenser and microcontroller in the bottom of the box
- Cut a wooden stick with 2.5 diameter to a length of 12 cm
- Cut two wooden sticks with 1cm diameter to a length of 5cm
- Drill a whole on both sides of the 2.5 diameter piece
